...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Journal.editor_address'
        db.delete_column('journalmanager_journal', 'editor_address')

        # Deleting field 'Journal.editor_address_city'
        db.delete_column('journalmanager_journal', 'editor_address_city')

        # Deleting field 'Journal.editor_address_state'
        db.delete_column('journalmanager_journal', 'editor_address_state')

        # Deleting field 'Journal.editor_address_country'
        db.delete_column('journalmanager_journal', 'editor_address_country')

        # Deleting field 'Journal.editor_name'
        db.delete_column('journalmanager_journal', 'editor_name')

        # Deleting field 'Journal.editor_email'
        db.delete_column('journalmanager_journal', 'editor_email')

        # Deleting field 'Journal.editor_phone2'
        db.delete_column('journalmanager_journal', 'editor_phone2')

        # Deleting field 'Journal.editor_phone1'
        db.delete_column('journalmanager_journal', 'editor_phone1')

        # Deleting field 'Journal.editor_address_zip'
        db.delete_column('journalmanager_journal', 'editor_address_zip')


    def backwards(self, orm):
        # Adding field 'Journal.editor_address'
        db.add_column('journalmanager_journal', 'editor_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)

        # Adding field 'Journal.editor_address_city'
        db.add_column('journalmanager_journal', 'editor_address_city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)

        # Adding field 'Journal.editor_address_state'
        db.add_column('journalmanager_journal', 'editor_address_state',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)

        # Adding field 'Journal.editor_address_country'
        db.add_column('journalmanager_journal', 'editor_address_country',
                      self.gf('scielo_extensions.modelfields.CountryField')(default='', max_length=2),
                      keep_default=False)

        # Adding field 'Journal.editor_name'
        db.add_column('journalmanager_journal', 'editor_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)

        # Adding field 'Journal.editor_email'
        db.add_column('journalmanager_journal', 'editor_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75),
                      keep_default=False)

        # Adding field 'Journal.editor_phone2'
        db.add_column('journalmanager_journal', 'editor_phone2',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Journal.editor_phone1'
        db.add_column('journalmanager_journal', 'editor_phone1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32),
                      keep_default=False)

        # Adding field 'Journal.editor_address_zip'
        db.add_column('journalmanager_journal', 'editor_address_zip',
    ...
    models = {
        ...
        'journalmanager.journal': {
            ...
            'chief_publishing_house': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'journals_i_lead'", 'null': 'True', 'to': "orm['journalmanager.PublishingHouse']"}),
            ...
            'publishing_house': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'journals'", 'null': 'True', 'to': "orm['journalmanager.PublishingHouse']"}),
        ...
        'journalmanager.publishinghouse': {
            ...
            'country': ('scielo_extensions.modelfields.CountryField', [], {'default': "''", 'max_length': '2', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'default': "''", 'max_length': '75', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
            'phone1': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32', 'blank': 'True'}),
            'phone2': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32', 'blank': 'True'}),
            'state': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128', 'blank': 'True'}),
            'zipcode': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64', 'blank': 'True'})
        },
