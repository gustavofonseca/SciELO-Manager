...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('journalmanager_publishinghouse', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('address', self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('state', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True)),
            ('zipcode', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True)),
            ('country', self.gf('scielo_extensions.modelfields.CountryField')(default='', max_length=2, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True)),
            ('phone1', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True)),
            ('phone2', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True)),
        ))
        db.send_create_signal('journalmanager', ['PublishingHouse'])

        # Adding field 'Journal.chief_publishing_house'
        db.add_column('journalmanager_journal', 'chief_publishing_house',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='journals_i_lead', null=True, to=orm['journalmanager.PublishingHouse']),
                      keep_default=False)

        # Adding field 'Journal.publishing_house'
        db.add_column('journalmanager_journal', 'publishing_house',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='journals', null=True, to=orm['journalmanager.PublishingHouse']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PublishingHouse'
        db.delete_table('journalmanager_publishinghouse')

        # Deleting field 'Journal.chief_publishing_house'
        db.delete_column('journalmanager_journal', 'chief_publishing_house_id')

        # Deleting field 'Journal.publishing_house'
        db.delete_column('journalmanager_journal', 'publishing_house_id')
